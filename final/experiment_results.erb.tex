...
To test our system, we implement a prototype client in the Ruby programming language\footnote{See http://github.com/rdp/p2pwebclient.} and 
use the client on multiple simultaneous members of the PlanetLab system, a pool of about 1000 servers scattered world-wide\footnote{It should be noted
that typically only about 300 are active at a time}.
For each test, a central ``driver" program contacts several members of the client pool and instructs them to download a specific url.  To
