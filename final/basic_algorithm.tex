...
\begin{figure*}
  \begin{center}
    \subfigure[Peer downloads meta-data]{\includegraphics[width=6cm]{description_pics/peer_step_1.png}\label{fig:yanc_step_1}}
    \subfigure[Peer downloads a list of peers that have a block]{\includegraphics[width=9cm]{description_pics/peer_step_2.png}\label{fig:yanc_step_2}}
    \subfigure[Peer adds itself to list of peers who have the block]{\includegraphics[width=7cm]{description_pics/peer_step_3.png}\label{fig:yanc_step_3}}
