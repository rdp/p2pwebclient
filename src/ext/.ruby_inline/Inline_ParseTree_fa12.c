...
# line 1021 "./lib/gems_here/ParseTree-2.2.0/lib/parse_tree.rb"
static VALUE parse_tree_for_meth(VALUE self, VALUE _klass, VALUE _method, VALUE _is_cls_meth) {
  ...
  if (strcmp(StringValuePtr(version), "1.8.7")) {
    rb_fatal("bad version, %s != 1.8.7\n", StringValuePtr(version));
  }
...
# line 1058 "./lib/gems_here/ParseTree-2.2.0/lib/parse_tree.rb"
...
extern "C" {
  ...
  void Init_Inline_ParseTree_fa12() {
    VALUE c = rb_cObject;
    c = rb_const_get(c, rb_intern("ParseTree"));
