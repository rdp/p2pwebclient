...
#require 'rubygems' 
require File.dirname(__FILE__) + '/rev_here'
#require 'rev'
...
module EventMachine
  ...
  class CallsBackToEM < Rev::TCPSocket
    ...
    def on_connect
      # @connection_timer.detach if @connection_timer # broken currently
    ...
    def connection_has_timed_out
      return if closed?
      close unless closed? # wonder if this works when you're within a half-connected phase.  I think it does.  What about DNS state?
